 ...
 * This file demonstrates how to integrate Walletcraft with a web frontend
 */

// For React/Vue/Angular applications
export class WalletcraftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new WalletcraftClient(provider, contractAddress);
