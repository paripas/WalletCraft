...
const contractABI = require("../artifacts/contracts/Walletcraft.sol/Walletcraft.json").abi;

program
    .name("walletcraft-cli")
    .description("CLI tool for Walletcraft smart contract")
    .version("1.0.0");
